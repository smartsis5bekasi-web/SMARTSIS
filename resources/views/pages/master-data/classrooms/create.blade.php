...
new #[Title('Tambah Kelas')] class extends Component {
    ...
    public function save(): void
    {
        ...
        Flux::toast(variant: 'success', text: __('Kelas ditambahkan.'));
...
<div class="flex h-full w-full flex-1 flex-col gap-6">
    <div class="flex flex-wrap items-end justify-between gap-3">
        <div>
            <flux:heading size="xl">{{ __('Tambah Kelas') }}</flux:heading>
            <flux:text class="mt-1">{{ __('Isi detail kelas baru.') }}</flux:text>
        </div>
