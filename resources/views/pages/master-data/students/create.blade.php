...
new #[Title('Tambah Siswa')] class extends Component {
    ...
    /**
     * Parent/guardian rows entered together with the student (F-04).
     *
     * @var array<int, array{name: string, relationship: string, phone: ?string}>
     */
    ...
    {
        $this->parents[] = ['name' => '', 'relationship' => 'Ayah', 'phone' => null];
    }
