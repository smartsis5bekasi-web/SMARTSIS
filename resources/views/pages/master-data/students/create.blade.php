    ...
    <form wire:submit="save" class="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
        <div class="mb-8 flex flex-col gap-2" x-data="{ photoPreview: null }">
            ...
            <span class="text-xs text-gray-500">{{ __('Keterangan Upload : (Maksimal: 2MB, Dimensi: 800x800 piksel)') }}</span>
               ...
               <div id="image-preview-placeholder" class="h-[200px] w-[200px] cursor-pointer rounded-2xl border-2 border-dashed border-primary-400 bg-gray-100" onclick="document.getElementById('image-input').click()">
...
<script>
    window.previewImage = function (event) {
        ...
        if (file) {
            ...
            preview.src = "{{ asset('assets/placeholder.png') }}";
        }
    }
</script>
@endpush