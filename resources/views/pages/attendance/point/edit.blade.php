...
new #[Title('Edit Aturan Poin')] class extends Component {
    ...
    public function mount(PointRule $pointRule): void
    {
        $this->pointRule = $pointRule;
        $this->name = $pointRule->name;
        $this->type = $pointRule->type->value;
        $this->source = $pointRule->source->value;
        $this->point = $pointRule->point;
        $this->is_active = $pointRule->is_active;
    }
    ...
    protected function rules(): array
    {
        ...
        return [
            'name' => ['required', 'string', 'max:100', Rule::unique('point_rules', 'name')->ignore($this->pointRule->id)],
...
<div class="flex h-full w-full flex-1 flex-col gap-6">
    <x-ui.page-header :title="__('Edit Aturan Poin')" :subtitle="__('Perbarui cara penambahan atau pengurangan poin.')">
        <x-slot:actions>
